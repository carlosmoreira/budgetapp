 ...
 */
	public static function checkSecurityKeys() {
		if (Configure::read('Security.salt') === 'jLyJEdTfAMvTVDQYKiQUDAqdsYeVJvlxovxawWVDKAtgtjNXeOMktPeLnrJUJYYB') {
		...
		if (Configure::read('Security.cipherSeed') === 'jLyJEdTfAMvTVDQYKiQUDAqdsYeVJvlxovxawWVDKAtgtjNXeOMktPeLnrJUJYYB') {
